...
describe('Remote Frame Buffer Protocol Client', function() {
    ...
    before(function () {
        ...
        var sQ = new Uint8Array(sock._sQbufferSize);
    ...
    describe('Public API Basic Behavior', function () {
        ...
        describe('#sendCtrlAlDel', function () {
            ...
            it('should sent ctrl[down]-alt[down]-del[down] then del[up]-alt[up]-ctrl[up]', function () {
                var expected = new Uint8Array(48);
                RFB.messages.keyEvent(expected, 0, 0xFFE3, 1);
                RFB.messages.keyEvent(expected, 8, 0xFFE9, 1);
                RFB.messages.keyEvent(expected, 16, 0xFFFF, 1);
                RFB.messages.keyEvent(expected, 24, 0xFFFF, 0);
                RFB.messages.keyEvent(expected, 32, 0xFFE9, 0);
                RFB.messages.keyEvent(expected, 40, 0xFFE3, 0);
        ...
        describe('#sendKey', function () {
            ...
            it('should send a single key with the given code and state (down = true)', function () {
                var expected = new Uint8Array(8);
                RFB.messages.keyEvent(expected, 0, 123, 1);
            ...
            it('should send both a down and up event if the state is not specified', function () {
                ...
                RFB.messages.keyEvent(expected, 0, 123, 1);
                RFB.messages.keyEvent(expected, 8, 123, 0);
                client.sendKey(123);
                expect(client._sock).to.have.sent(expected);
            });
        ...
        describe('#clipboardPasteFrom', function () {
            ...
            it('should send the given text in a paste event', function () {
                ...
                RFB.messages.clientCutText(expected, 0, 'abc');
    ...
    describe('Protocol Initialization States', function () {
        ...
        describe('ServerInitialisation', function () {
            ...
            it('should reply with the pixel format, client encodings, and initial update request', function () {
                ...
                var expected = new Uint8Array(34 + 4 * (client._encodings.length - 1));
                RFB.messages.pixelFormat(expected, 0, 4, 3, true);
                var len = RFB.messages.clientEncodings(expected, 20, client._encodings, false, true);
                var expected_cdr = { cleanBox: { x: 0, y: 0, w: 0, h: 0 },
                                     dirtyBoxes: [ { x: 0, y: 0, w: 27, h: 32 } ] };
                RFB.messages.fbUpdateRequests(expected, (24 + 4 * (client._encodings.length - 1)), expected_cdr, 27, 32);
    ...
    describe('Protocol Message Processing After Completing Initialization', function () {
        ...
        describe('Framebuffer Update Handling', function () {
            ...
            it('should send an update request if there is sufficient data', function () {
                var expected_msg = new Uint8Array(10);
                var expected_cdr = { cleanBox: { x: 0, y: 0, w: 0, h: 0 },
                                     dirtyBoxes: [ { x: 0, y: 0, w: 240, h: 20 } ] };
                RFB.messages.fbUpdateRequests(expected_msg, 0, expected_cdr, 240, 20);
    ...
    describe('Asynchronous Events', function () {
        describe('Mouse event handlers', function () {
            ...
            it('should send a pointer event on mouse button presses', function () {
                ...
                var pointer_msg = new Uint8Array(6);
                RFB.messages.pointerEvent(pointer_msg, 0, 10, 12, 0x001);
                expect(client._sock).to.have.sent(pointer_msg);
            });
            ...
            it('should send a mask of 0 on mouseup', function () {
                ...
                var pointer_msg = new Uint8Array(6);
                RFB.messages.pointerEvent(pointer_msg, 0, 10, 12, 0x000);
                expect(client._sock).to.have.sent(pointer_msg);
            });
            ...
            it('should set the button mask so that future mouse movements use it', function () {
                ...
                var pointer_msg = new Uint8Array(12);
                RFB.messages.pointerEvent(pointer_msg, 0, 10, 12, 0x010);
                RFB.messages.pointerEvent(pointer_msg, 6, 13, 9, 0x010);
                expect(client._sock).to.have.sent(pointer_msg);
            });
        ...
        describe('Keyboard Event Handlers', function () {
            ...
            it('should send a key message on a key press', function () {
                ...
                var key_msg = new Uint8Array(8);
                RFB.messages.keyEvent(key_msg, 0, 1234, 1);
                expect(client._sock).to.have.sent(key_msg);
            });
