...
(function () {
    ...
    RFB.prototype = {
        ...
        _handleMouseButton: function (x, y, down, bmask) {
            ...
            RFB.messages.pointerEvent(this._mouse_arr, this._mouse_arr.length, this._display.absX(x), this._display.absY(y), this._mouse_buttonMask);
            this._sock.send(this._mouse_arr);
            this._mouse_arr = [];
        },
        ...
        display_tight: function (isTightPNG) {
            ...
            var handlePalette = function () {
                ...
                if (rowSize * this._FBU.height < 12) {
                    ...
                    // begin inline getTightCLength (returning two-item arrays is bad, ok?)
